        ...
        try:
            ...
            if os.path.exists(xml_path):
                ...
                if extension == "xml":
                    ...
                    raise ValueError(f"Unsupported file extension: '{extension}'. Please provide an XML or URDF file.")
            else:
            ...
            raise ValueError(f"Invalid value encountered while loading the model: {e}") from e
